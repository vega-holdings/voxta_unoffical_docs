---
title: "Contexts"
url: "https://doc.voxta.ai/docs/contexts/"
...
Keep in mind that contexts are powerful and will be used continuously. Consider using notes or secrets to reduce the amount of contexts you need.
## Filters
You can search for contexts using the search bar at the top of the page. You can also set flags in the `Test flags` field to see the contexts that will be used at any given time in a chat.
## Context
  * Context: The template that will be added to the chat prompt. Always refer to the character in the third person using their name, such as `{{ char }} wears a blindfold and cannot see {{ user }}.`.
  * Conditions: A flag condition, see [Flags](https://doc.voxta.ai/docs/flags/), for more information.
...
[](https://doc.voxta.ai/docs/events/) [Next ](https://doc.voxta.ai/docs/templates/)
  * [Filters](https://doc.voxta.ai/docs/contexts/#filters)
  * [Context](https://doc.voxta.ai/docs/contexts/#context)
  * [Interface](https://doc.voxta.ai/docs/contexts/#interface)
