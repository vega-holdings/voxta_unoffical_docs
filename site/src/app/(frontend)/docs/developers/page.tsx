...
export const metadata = {
  title: 'Developer Documentation - Voxta Unofficial Docs',
  description: 'Developer guides and SDK documentation for Voxta',
}
  ...
  return (
    <div className="docs-list-page">
      ...
      <p className="page-description">
        SDK guides, API documentation, and developer resources for building with Voxta.
      </p>
      ...
      {docs.docs.length === 0 && (
        <p style={{ color: 'var(--text-muted)' }}>No developer documentation yet.</p>
      )}
    </div>
  )
}
