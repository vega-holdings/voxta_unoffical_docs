---
title: "Wizard"
url: "https://doc.voxta.ai/docs/wizard/"
...
# Wizard
The Wizard is a simple setup tool in Voxta. It helps users quickly set up services like Text Generation/Large Language Model (LLM), Text To Speech (TTS), and Speech To Text (STT) for their AI characters. No matter your tech skill level, the Voxta Wizard makes the setup easy and straightforward.
![](https://doc.voxta.ai/images/uploads/snag-0454.jpg)
![Wizard](https://doc.voxta.ai/images/uploads/snag-0453.jpg)
  * Text Generation: Services to generate text for your characters (large language models)
  * Text To Speech: Services to synthesize your character’s voice
  * Speech To Text: Transcription services for your speech, so the AI can hear it
  * Action Inference and Summarization: Services capable of executing instructions (large language models)


> Note: Some services are hosted online and some can run locally, but you need a good graphics card to run.
[](https://doc.voxta.ai/docs/add-service/) [Next ](https://doc.voxta.ai/docs/benchmarks/)
[ ](https://voxta.ai/)
